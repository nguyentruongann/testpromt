...
from frappe.translate import get_app_translations
	...
	context.update(
		{
			...
			"_messages": json.dumps(
				frappe.as_json(get_app_translations(), indent=None, separators=(",", ":"))
			),
		}
	)
...
def get_context_for_dev():
	...
	return json.dumps(
		{
			"boot": get_boot(),
			"_messages": get_app_translations(),
		}
	)
