...
from frappe.utils import add_days, cint, date_diff, flt, getdate, nowdate, today
...
class InnoSalesInvoice(SalesInvoice):
	...
	def make_loyalty_point_entry(self):
		date_of_birth = frappe.get_value("Customer", self.customer, "custom_date_of_birth")
